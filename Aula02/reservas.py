...
# Cria um DataFrame com os dados das reservas
data_reservas = {
...
tipo_quarto_mais_reservado = df_reservas['Tipo de Quarto'].value_counts(
).idxmax()
media_noites = (pd.to_datetime(
    df_reservas['Data de Check-out']) - pd.to_datetime(df_reservas['Data de Check-in'])).mean().days
